        ...
        function () {
          ...
          $("#reindeer").animate(
            ...
            function () {
              $(".message").typed({
                strings: [
                  "<<< Merry Christmas With Ngoc May >>>",
                  "Chúc Bé người yêu của anh có một mùa giáng sinh an lành và ấm áp bên gia đình, người thân và bạn bè. Chúc em gặp nhiều may mắn và yêu anh nhiều Hơn nữa nhé!!!",
                ],
                typeSpeed: 250,
                startDelay: 500,
                backSpeed: 50,
