...
<section class="wrapper" id="wrapper">
    <div class="products">
        ...
        <ul class="product-content">
            <?php
            $sql_product_outstan = mysqli_query($conn, "SELECT * FROM tbl_product WHERE product_outstan='1' LIMIT 8");
            $giakhuyenmai = 0;
    ...
    ?>
        <div class="products">
            ...
            <ul class="product-content">
                <?php
                $sql_product = mysqli_query($conn, "SELECT * FROM tbl_product ORDER BY product_id ASC LIMIT 40");
                $giakhuyenmai = 0;
