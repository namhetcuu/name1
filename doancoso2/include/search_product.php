...
$sql_product = mysqli_query($conn, "SELECT * FROM tbl_product,tbl_category WHERE tbl_product.category_id = tbl_category.category_id AND  tbl_product.product_name LIKE '%$key%'");
?>
<section class="page">
