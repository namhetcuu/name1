          ...
          <table class="table">
            ...
            <tbody>
                ...
                <tr>
                      ...
                      <td>
                      <a href="?controller=order&action=detailOrder&id=<?php echo $order->order_code; ?>">View Detail</a> || 
                    <a href="?controller=order&action=delorder&id=<?php echo $order->order_code; ?>">Delete</a>
                      </td>
