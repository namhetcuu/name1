...
<section class="home" id="home" style="background: url('theme/images/hero/hero-9.jpg')
 no-repeat center; min-height: 94vh; position: relative;top:-15px">
    <div class="content">
      ...
      <a href="?controller=product&action=index" class="btn">Xem cửa hàng</a>
    </div>
  </section>
<section class="products" id="products">
    ...
    <div class="box-container">
      <?php
      $db = Db::getInstance();
      $sql_select =$db->query("SELECT * FROM sanpham LIMIT 4");
      foreach($sql_select->fetchAll() as $row){?>

      <div class="box">
        <span class="discount">-10%</span>
        <div class="image">
          <img src="theme/images/<?php echo $row['sanpham_image'] ?>" alt="">
    ...
    <?php
      $db = Db::getInstance();
      $sql_select =$db->query("SELECT * FROM sanpham WHERE danhmuc_id=1");
      foreach($sql_select->fetchAll() as $row){?>
      <div class="box">
        <span class="discount">-10%</span>
        <div class="image">
          <img src="theme/images/<?= $row['sanpham_image'] ?>" alt="">
          <div class="icons">
            <!-- <a href="" class="cart-btn">Thêm vào giỏ</a> -->
            <form action="?act=cart" method="post">
              <input type="hidden" name="id_sanpham" value="<?= $row['sanpham_id'];?>">
    ...
    <?php
      $db = Db::getInstance();
      $sql_select =$db->query("SELECT * FROM sanpham WHERE danhmuc_id=3");
      foreach($sql_select->fetchAll() as $row){?>
      <div class="box">
        <span class="discount">-10%</span>
        <div class="image">
    ...
    <?php
      $db = Db::getInstance();
      $sql_select =$db->query("SELECT * FROM sanpham WHERE danhmuc_id=6");
      foreach($sql_select->fetchAll() as $row){?>
      <div class="box">
        <span class="discount">-10%</span>
        <div class="image">
