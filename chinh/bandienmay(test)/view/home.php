...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner">
			...
			<div class="carousel-item item1 active" style="background: url('./view/images/hero/hero-2.jpg') no-repeat center;">
				<!-- <div class="container">
					<div class="row">
						<div class="col-12">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 col-sm-6">
                ...
                <div class="single-feature feature-style-2 mb-30">
                    ...
                    <div class="content">
                        ...
                        <p>Áp dụng với đơn hàng trên 200.000đ</p>
                    </div>
                </div>
                <!-- Single Faeture End -->
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6">
                ...
                <div class="single-feature feature-style-2 mb-30">
                    ...
                    <div class="content">
                        <h2>Chính sách hoàn trả trong 30 ngày</h2>
                        <p>Áp dụng tất cả đơn hàng</p>
                    </div>
                </div>
                <!-- Single Faeture End -->
            </div>
		...
		<div class="container py-xl-4 py-lg-2">
			...
			<div class="row">
				...
				<div class="agileinfo-ads-display col-lg-9">
					<div class="wrapper">
						<?php
						$sql_cate_home = mysqli_query($conn,"SELECT * FROM danhmuc ORDER BY id DESC");
						while($row_cate_home = mysqli_fetch_array($sql_cate_home)){
							$id_category = $row_cate_home['id'];
						?>
						<!-- first section -->
						<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
							<h3 class="heading-tittle text-center font-italic"><?php echo $row_cate_home['name'] ?></h3>
							<div class="row">
								<?php
								$sql_product = mysqli_query($conn,"SELECT * FROM sanpham ORDER BY id DESC");
								while($row_sanpham = mysqli_fetch_array($sql_product)){ 
									if($row_sanpham['id']==$id_category){
								?>
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											<img src="./view/images/<?php echo $row_sanpham['image'] ?>" alt="">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="?quanly=chitietsp&id=<?php echo $row_sanpham['id'] ?>" class="link-product-add-cart">Xem sản phẩm</a>
												</div>
											</div>
										</div>
				...
				<div class="col-lg-3 mt-lg-0 mt-4 p-lg-0">
					<div class="side-bar p-sm-4 p-3">
						...
						<div class="left-side border-bottom py-2">
							...
							<ul>
								<?php 
									$sql_category_sidebar = mysqli_query($conn,'SELECT * FROM category ORDER BY category_id DESC');
