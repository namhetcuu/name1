    ...
    <section class="register" id="register" style="overflow: hidden; height: 900px">
      ...
      <div class="form">
        ...
        <div class="form-content" style="justify-content: flex-start;">
          <input value="Register" type="submit" class="btn" style="font-size: 15px;"></input>
          <p style="margin-left: 10px;font-size: 1.5rem;">Nếu bạn đã có tài khoản, vui lòng đăng nhập <a href="?act=login">tại đây</a></p>
        </div>
      </div>
      </form>
    </section>
