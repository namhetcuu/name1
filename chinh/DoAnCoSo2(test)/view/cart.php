...
if(!isset($_SESSION['dangnhap_home'])){?>
  ...
  <p class="mb-0">Wish you a happy day !!</p>
        ...
        <p><a href="?act=login" style="margin-bottom: 200px;">Go to login page</a></p>
        
<?php }else{?>
    <section class="cart" id="cart">
        <h1 class="heading">Giỏ hàng
        </h1>
        <form action="?act=cart" method="post" id="form">
                    ...
                    while($value = mysqli_fetch_array($result)){
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <!-- <input type="submit" value="Delete" id="del_btn" name="capnhat" class="btn btn-outline" style="transition: none;"> -->
