...
<section class="products" id="products">
    <div class="product-content">
        ...
        <div class="filter-category">
          <ul style="flex-wrap: wrap;">
            <?php
              ...
              <?php }
              ?>
              <li><a class="btn btn-outline-primary" style="margin-top: 0" href="?act=product">View All Product</a></li>
          </ul>
        </div>
      ...
      <div class="box-container" style="justify-content: unset; gap: 0rem">
        <?php
          $sql = "SELECT * FROM sanpham WHERE danhmuc_id = $id_dm";
                    ...
                    <div class="men-pro-item simpleCart_shelfItem">
                      ...
                      <div class="item-info-product text-center border-top mt-4">
                        ...
                        <div class="info-product-price my-2">
                          <span class="item_price"><?= $row['sanpham_giakhuyenmai'];?></span>
                          <del><?= $row['sanpham_gia'];?></del>
                        </div>
